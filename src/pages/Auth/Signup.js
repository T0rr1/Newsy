        ...
        <IonPage>
            ...
            <IonContent>
                <IonItem lines='full'>
                    ...
                    <IonInput name='name' type='text' values={values.name} onIonChange={handleChange} required></IonInput>
                </IonItem>
                <IonItem lines='full'>
                    <IonLabel position='floating'>Email</IonLabel>
                    <IonInput name='email' type='text' values={values.email} onIonChange={handleChange} required></IonInput>
                </IonItem>
                <IonItem lines='full'>
                ...
                <IonRow>
                    <IonCol>
                        <IonButton type='submit' color='primary' expand='block' onClick={handleSubmit} disabled={isSubmitting}>Sign Up</IonButton>
                    </IonCol>
                </IonRow>
            </IonContent>
        </IonPage>
